...
# PLOT 4
# Script to produce the fourth and final plot for course project 1
...
#Plot 4: Grid of 4 plots
png(filename = "plot4.png",width = 480, height = 480)
par(mfrow = c(2, 2))
with(data, {
  plot(timeAndDate, Global_active_power,type ="l" ,xlab = "",ylab = "Global Active Power")
  ...
  plot(timeAndDate,Global_reactive_power,type ="l",xlab = 'datetime', ylab = "Global_reactive_power")
})
dev.off()
